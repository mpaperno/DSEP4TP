...
static QLatin1String httpResponseTextForCode(quint16 code)
{
	static QHash<quint16, QLatin1String> s {
		...
		{ 203, QLatin1String("Non-Authoritative Information") },
		{ 204, QLatin1String("No Content") },
		{ 205, QLatin1String("Reset Content") },
		{ 206, QLatin1String("Partial Content") },
		{ 207, QLatin1String("Multi-Status") },
		{ 208, QLatin1String("Already Reported") },
		{ 226, QLatin1String("IM Used") },
		{ 300, QLatin1String("Multiple Choices") },
		{ 301, QLatin1String("Moved Permanently") },
		{ 302, QLatin1String("Found") },
		{ 303, QLatin1String("See Other") },
		{ 304, QLatin1String("Not Modified") },
		{ 305, QLatin1String("Use Proxy") },
		{ 307, QLatin1String("Temporary Redirect") },
		{ 308, QLatin1String("Permanent Redirect") },
		{ 400, QLatin1String("Bad Request") },
		{ 401, QLatin1String("Unauthorized") },
		{ 402, QLatin1String("Payment Required") },
		{ 403, QLatin1String("Forbidden") },
		{ 404, QLatin1String("Not Found") },
		{ 405, QLatin1String("Method Not Allowed") },
		{ 406, QLatin1String("Not Acceptable") },
		{ 407, QLatin1String("Proxy Authentication Required") },
		{ 408, QLatin1String("Request Timeout") },
		{ 409, QLatin1String("Conflict") },
		{ 410, QLatin1String("Gone") },
		{ 411, QLatin1String("Length Required") },
		{ 412, QLatin1String("Precondition Failed") },
		{ 413, QLatin1String("Content Too Large") },
		{ 414, QLatin1String("URI Too Long") },
		{ 415, QLatin1String("Unsupported Media Type") },
		{ 416, QLatin1String("Range Not Satisfiable") },
		{ 417, QLatin1String("Expectation Failed") },
		{ 418, QLatin1String("Invalid Operation") },
		{ 421, QLatin1String("Misdirected Request") },
		{ 422, QLatin1String("Unprocessable Content") },
		{ 423, QLatin1String("Locked") },
		{ 424, QLatin1String("Failed Dependency") },
		{ 425, QLatin1String("Too Early") },
		{ 426, QLatin1String("Upgrade Required") },
		{ 428, QLatin1String("Precondition Required") },
		{ 429, QLatin1String("Too Many Requests") },
		{ 431, QLatin1String("Request Header Fields Too Large") },
		{ 451, QLatin1String("Unavailable For Legal Reasons") },
		{ 500, QLatin1String("Internal Server Error") },
		{ 501, QLatin1String("Not Implemented") },
		{ 502, QLatin1String("Bad Gateway") },
		{ 503, QLatin1String("Service Unavailable") },
		{ 504, QLatin1String("Gateway Timeout") },
		{ 505, QLatin1String("HTTP Version Not Supported") },
		{ 506, QLatin1String("Variant Also Negotiates") },
		{ 507, QLatin1String("Insufficient Storage") },
		{ 508, QLatin1String("Loop Detected") },
		{ 509, QLatin1String("Unassigned") },
		{ 510, QLatin1String("Not Extended") },
		{ 511, QLatin1String("Network Authentication Required") },
	};
	return s.value(code, QLatin1String("Unknown status code"));
}
...
ReturnedValue NodePrototype::getProto(ExecutionEngine *engine)
{
    Scope scope(engine);
...
ReturnedValue CharacterData::prototype(ExecutionEngine *engine)
{
    QQmlXMLHttpRequestData *d = xhrdata(engine);
...
ReturnedValue Text::prototype(ExecutionEngine *engine)
{
    QQmlXMLHttpRequestData *d = xhrdata(engine);
    if (d->textPrototype.isUndefined()) {
        ...
        ScopedObject p(scope, engine->newObject());
        ScopedObject pp(scope);
        p->setPrototypeUnchecked((pp = CharacterData::prototype(engine)));
...
ReturnedValue CDATA::prototype(ExecutionEngine *engine)
{
...
ReturnedValue Document::prototype(ExecutionEngine *engine)
{
    QQmlXMLHttpRequestData *d = xhrdata(engine);
...
class DseJsonParser
{
		...
		const QByteArray &jsbody;
	public:
		explicit DseJsonParser(QV4::ExecutionEngine *engine, const QByteArray &body) : e(engine), jsbody(body)
		{
		}

		ReturnedValue parse(QJsonParseError *error)
		{
			QJsonDocument jsdoc = QJsonDocument::fromJson(jsbody, error);
			//qDebug() << error->error << error->errorString() << '\n' << jsbody;
			if (jsdoc.isNull())
				return Encode::null();
			if (jsdoc.isObject())
				return parseObject(jsdoc.object());
			if (jsdoc.isArray())
				return parseArray(jsdoc.array());
			return Encode::undefined();
		}

		ReturnedValue parseObject(const QJsonObject &jsobj)
		{
			Scope scope(e);
			ScopedObject obj(scope, e->newObject());
      for (auto it = jsobj.begin(), en = jsobj.end(); it != en; ++it) {
          QJsonValue jsval = it.value();

					ScopedValue value(scope);
					if (!parseValue(jsval, value))
						return Encode::undefined();

					QString key = it.key();
					ScopedString s(scope, e->newString(key));
					PropertyKey skey = s->toPropertyKey();
					if (skey.isArrayIndex()) {
						obj->put(skey.asArrayIndex(), value);
					} else {
						obj->insertMember(s, value);
					}
      }
      return obj.asReturnedValue();
		}

		ReturnedValue parseArray(const QJsonArray &ary)
		{
			Scope scope(e);
	    ScopedArrayObject array(scope, e->newArrayObject());
			uint i = 0;
			for (auto it = ary.begin(), en = ary.end(); it < en; ++it) {
				QJsonValue jsval = *it;
				ScopedValue value(scope);
				if (!parseValue(jsval, value))
					return Encode::undefined();
				array->arraySet(++i, value);

			}
			return array.asReturnedValue();
		}

		bool parseValue(const QJsonValue &jsval, Value *val)
		{
			if (jsval.isBool()) {
				*val = Value::fromBoolean(jsval.toBool());
	    }
	    else if (jsval.isString())
	    {
				*val = Value::fromHeapObject(e->newString(jsval.toString()));
	    }
	    else if (jsval.isDouble())
	    {
				*val = Value::fromDouble(jsval.toDouble());
	    }
			...
			else if (jsval.isUndefined())
	    {
				...
				*val = parseObject(jsval.toObject());
			}
			else if (jsval.isArray()) {
				*val = parseArray(jsval.toArray());
			}
			else {
				return false;
			}
...
public:
    ...
    QQmlXMLHttpRequest(QV4::ExecutionEngine *v4);
    ...
    ReturnedValue send(Object *thisObject,
                   #if (QT_VERSION >= QT_VERSION_CHECK(6, 0, 0))
    ...
    QString headers() const;
		HeadersList currentHeaders() const;
    ...
    void setResponseType(const QString &);
		...
		void setWithCredentials(bool with);

		int redirect() const;
		void setRedirect(int newRedirect);
...
private:
    ...
    static void dispatchCallbackNow(Object *thisObj, bool done, bool hasError, QNetworkReply::NetworkError error);
    void dispatchCallbackSafely();
		void dispatchCallbackSafely(const QString &cbname);
		static void dispatchCb(Object *thisObj, const QString &eventName);
    ...
    QNetworkRequest m_request;
		...
		int m_redirect;  // QNetworkRequest::RedirectPolicy
...
{
	// workaround for apparent bug in QNetwork v6
	if (m_statusText.isEmpty() && m_status)
		return httpResponseTextForCode(m_status);
	return m_statusText;
}

QNetworkReply::NetworkError QQmlXMLHttpRequest::error() const
{
	return m_error;
}

qint64 QQmlXMLHttpRequest::bytesTotal() const
{
	return m_bTotal;
}

qint64 QQmlXMLHttpRequest::bytesTransferred() const
{
	return m_bTransfer;
}
...
void QQmlXMLHttpRequest::setUrl(const QUrl &newUrl)
{
	m_url = newUrl;
}

QUrl QQmlXMLHttpRequest::responseUrl() const
{
	return m_responseUrl;
}

QString QQmlXMLHttpRequest::method() const
{
	return m_method;
}

void QQmlXMLHttpRequest::setMethod(const QString &newMethod)
{
	m_method = newMethod;
}

QQmlXMLHttpRequest::LoadType QQmlXMLHttpRequest::loadType() const
{
	return m_request.attribute(QNetworkRequest::SynchronousRequestAttribute, false).toBool() ? SynchronousLoad : AsynchronousLoad;
}

void QQmlXMLHttpRequest::setLoadType(LoadType type)
{
	m_request.setAttribute(QNetworkRequest::SynchronousRequestAttribute, type == SynchronousLoad);
}
...
void QQmlXMLHttpRequest::setMimeType(const QByteArray &type)
{
	m_mime = type;
}
...
void QQmlXMLHttpRequest::setRedirect(int newRedirect)
{
	m_redirect = newRedirect;
}

bool QQmlXMLHttpRequest::withCredentials() const
{
	return m_request.attribute(QNetworkRequest::CookieLoadControlAttribute, QNetworkRequest::Automatic).toInt() == QNetworkRequest::Automatic;
}

void QQmlXMLHttpRequest::setWithCredentials(bool with)
{
	QNetworkRequest::LoadControl lc = with ? QNetworkRequest::Automatic : QNetworkRequest::Manual;
	m_request.setAttribute(QNetworkRequest::CookieLoadControlAttribute, lc);
	m_request.setAttribute(QNetworkRequest::CookieSaveControlAttribute, lc);
	m_request.setAttribute(QNetworkRequest::AuthenticationReuseAttribute, lc);
}
...
void QQmlXMLHttpRequest::addHeader(const QString &name, const QString &value)
{
    QByteArray utfname = name.toUtf8();
		QByteArray utfvalue = value.toUtf8();

		m_headersList.append({utfname, utfvalue});
    if (m_addedHeaders.contains(name, Qt::CaseInsensitive)) {
        m_request.setRawHeader(utfname, m_request.rawHeader(utfname) + ',' + utfvalue);
    } else {
        m_request.setRawHeader(utfname, utfvalue);
	...
	if (!m_headersList.isEmpty()) {
		...
		for (const HeaderPair &header : m_headersList) {
			if (header.first == utfname)
				res << QString::fromUtf8(header.second);
		}
	}
...
QQmlXMLHttpRequest::HeadersList QQmlXMLHttpRequest::currentHeaders() const
{
...
ReturnedValue QQmlXMLHttpRequest::send(Object *thisObject,
#if (QT_VERSION >= QT_VERSION_CHECK(6, 0, 0))
				 const QQmlRefPointer<QQmlContextData> &context,
#else
				QQmlContextData *context,
...
void QQmlXMLHttpRequest::readyRead()
{
    ...
    m_statusText =
		...
		if (xhrDump()) {
        qWarning().nospace() << "XMLHttpRequest: READY READ " << qPrintable(m_url.toString()) << " STATUS " << m_status << " '" << m_statusText << "'";
    }
    ...
    m_responseEntityBody.append(m_network->readAll());
		if (wasEmpty) {
			if (!m_responseEntityBody.isEmpty()) {
				m_state = Loading;
				dispatchCallbackSafely(QStringLiteral("loadstart"));
				dispatchCallbackSafely();
			}
		}
		else if (!m_parsedDocument.isEmpty()) {
			m_parsedDocument.clear();
		}
...
void QQmlXMLHttpRequest::error(QNetworkReply::NetworkError error)
{
    ...
    if (xhrDump()) {
        ...
        qWarning().nospace() << "    " << error << " STATUS " << m_status << " '" << m_statusText << "'";
    }
...
void QQmlXMLHttpRequest::finished()
{
    m_redirectCount++;
		if (m_redirectCount < XMLHTTPREQUEST_MAXIMUM_REDIRECT_RECURSION) {
			...
			if (redirect.isValid() && m_redirect != QNetworkRequest::ManualRedirectPolicy) {
				//if (m_redirect == QNetworkRequest::UserVerifiedRedirectPolicy) {
				//	// this is the "error" option for the XHR.redirect property
				//	error(QNetworkReply::ContentReSendError);
				//	return;
				//}
				QUrl url = m_network->url().resolved(redirect.toUrl());
				const QUrl origUrl = m_request.url();
				if (!QQmlFile::isLocalFile(url) &&
				    //  -1 is the default "follow" option
				    (m_redirect == -1 ||
				     //  this is the "same-origin" option
				     (m_redirect == QNetworkRequest::SameOriginRedirectPolicy && url.scheme() == origUrl.scheme() && url.host() == origUrl.host() && url.port() == origUrl.port()) ||
				     //  this is the "no-less-safe" option
				     (m_redirect == QNetworkRequest::NoLessSafeRedirectPolicy && (url.scheme() == origUrl.scheme() || (url.scheme() == QLatin1String("https") && origUrl.scheme() == QLatin1String("http"))))
				    )
				) {
    ...
    if (xhrDump()) {
        qWarning().nospace() << "XMLHttpRequest: RESPONSE " << qPrintable(m_url.toString()) << " STATUS " << m_status << " '" << m_network->attribute(QNetworkRequest::HttpReasonPhraseAttribute).toByteArray() << "'";
        if (!m_responseEntityBody.isEmpty()) {
            qWarning().nospace() << "                "
...
void QQmlXMLHttpRequest::dlProgress(qint64 bytes, quint64 total)
{
	m_bTransfer = bytes;
	m_bTotal = total;
	dispatchCallbackSafely(QStringLiteral("progress"));
}
...
QV4::ReturnedValue QQmlXMLHttpRequest::jsonResponseBody(QV4::ExecutionEngine* engine)
{
    if (m_parsedDocument.isEmpty()) {
        ...
        m_parsedDocument.set(engine, jsonObject);
    }
...
{
    dispatchCallbackNow(thisObj, m_state == Done, m_errorFlag, m_error);
}

void QQmlXMLHttpRequest::dispatchCallbackNow(Object *thisObj, bool done, bool hasError, QNetworkReply::NetworkError error)
{
    Q_ASSERT(thisObj);
...
//    };
    ...
    dispatchCb(thisObj, QStringLiteral("readystatechange"));
    if (done) {
			if (hasError) {
				if (error == QNetworkReply::TimeoutError)
					dispatchCb(thisObj, QStringLiteral("timeout"));
				else if (error == QNetworkReply::OperationCanceledError)
					dispatchCb(thisObj, QStringLiteral("abort"));
				dispatchCb(thisObj, QStringLiteral("error"));
			}
			else {
				dispatchCb(thisObj, QStringLiteral("load"));
			}
			dispatchCb(thisObj, QStringLiteral("loadend"));
    }
}
...
void QQmlXMLHttpRequest::dispatchCallbackSafely(const QString &cbname)
{
    if (m_wasConstructedWithQmlContext && m_qmlContext.isNull())
        return;
    dispatchCb(m_thisObject.as<Object>(), cbname);
}
...
void QQmlXMLHttpRequest::dispatchCb(Object *thisObj, const QString &eventName)
{
	ExecutionEngine *e = thisObj->engine();
	QV4::Scope scope(e);
	ScopedString cbstr(scope, e->newString(QStringLiteral("on") + eventName));
	ScopedFunctionObject callback(scope, thisObj->get(cbstr));
	// not an error, but no event handler to call.
	if (!callback)
			return;

	Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObj->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
		return;
  QQmlXMLHttpRequest *r = w->d()->request;
	ScopedObject obj(scope, e->newObject());
	obj->put(ScopedString(scope, e->newIdentifier(QStringLiteral("type"))), ScopedValue(scope, Value::fromHeapObject(e->newString(eventName))));
	obj->put(ScopedString(scope, e->newIdentifier(QStringLiteral("lengthComputable"))), ScopedValue(scope, Value::fromBoolean(r->bytesTotal() > 0)));
	obj->put(ScopedString(scope, e->newIdentifier(QStringLiteral("loaded"))), ScopedValue(scope, Value::fromDouble(double(r->bytesTransferred()))));
	obj->put(ScopedString(scope, e->newIdentifier(QStringLiteral("total"))), ScopedValue(scope, Value::fromDouble(double(r->bytesTotal()))));
...
struct QQmlXMLHttpRequestCtor : public FunctionObject
{
    ...
    static ReturnedValue method_set_responseType(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		// extended
		static ReturnedValue method_get_timeout(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_set_timeout(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_withCredentials(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_set_withCredentials(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_responseURL(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);

		// non standard
		static ReturnedValue method_get_responseJSON(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_responseBuffer(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_method(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_set_method(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_url(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_set_url(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_async(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_set_async(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_redirect(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_set_redirect(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
		static ReturnedValue method_get_headers(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc);
};
...
void QQmlXMLHttpRequestCtor::setupProto()
{
    ...
    p->defineAccessorProperty(QStringLiteral("response"), method_get_response, nullptr);
		...
		// non-standard
		p->defineAccessorProperty(QStringLiteral("responseJSON"), method_get_responseJSON, nullptr);
		p->defineAccessorProperty(QStringLiteral("responseBuffer"), method_get_responseBuffer, nullptr);
		p->defineAccessorProperty(QStringLiteral("headers"), method_get_headers, nullptr);

    // Read-write properties
    p->defineAccessorProperty(QStringLiteral("responseType"), method_get_responseType, method_set_responseType);
		p->defineAccessorProperty(QStringLiteral("timeout"), method_get_timeout, method_set_timeout);
		p->defineAccessorProperty(QStringLiteral("withCredentials"), method_get_withCredentials, method_set_withCredentials);
		// non-standard
		p->defineAccessorProperty(QStringLiteral("method"), method_get_method, method_set_method);
		p->defineAccessorProperty(QStringLiteral("url"), method_get_url, method_set_url);
		p->defineAccessorProperty(QStringLiteral("async"), method_get_async, method_set_async);
		p->defineAccessorProperty(QStringLiteral("redirect"), method_get_redirect, method_set_redirect);

    // State values
    p->defineReadonlyProperty(QStringLiteral("UNSENT"), Value::fromInt32(QQmlXMLHttpRequest::Unsent));
    p->defineReadonlyProperty(QStringLiteral("OPENED"), Value::fromInt32(QQmlXMLHttpRequest::Opened));
    p->defineReadonlyProperty(QStringLiteral("HEADERS_RECEIVED"), Value::fromInt32(QQmlXMLHttpRequest::HeadersReceived));
    p->defineReadonlyProperty(QStringLiteral("LOADING"), Value::fromInt32(QQmlXMLHttpRequest::Loading));
    p->defineReadonlyProperty(QStringLiteral("DONE"), Value::fromInt32(QQmlXMLHttpRequest::Done));
}

static bool isValidRequestMethod(const QString &method)
{
	return (
		method == QLatin1String("GET") ||
...
ReturnedValue QQmlXMLHttpRequestCtor::method_open(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
    ...
    // Argument 1 - URL
		QUrl url;
		if (argc > 1) {
			url = QUrl(argv[1].toQStringNoThrow());

			if (url.isRelative()) {
#if (QT_VERSION >= QT_VERSION_CHECK(6, 0, 0))
				if (QQmlRefPointer<QQmlContextData> qmlContextData = scope.engine->callingQmlContext())
#else
				if (QQmlContextData *qmlContextData = scope.engine->callingQmlContext())
#endif
			...
			if (argc > 3)
				url.setUserName(argv[3].toQStringNoThrow());
			if (argc > 4)
				url.setPassword(argv[4].toQStringNoThrow());
    ...
    if (argc > 2) {
				r->setLoadType(argv[2].booleanValue() ?
				      QQmlXMLHttpRequest::AsynchronousLoad :
				      QQmlXMLHttpRequest::SynchronousLoad);
    }
...
ReturnedValue QQmlXMLHttpRequestCtor::method_setRequestHeader(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
    ...
    if (
		    nameUpper == QLatin1String("ACCEPT-CHARSET") ||
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_timeout(const FunctionObject *b, const Value *thisObject, const Value *, int )
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
      V4THROW_REFERENCE("Not an XMLHttpRequest object");
  QQmlXMLHttpRequest *r = w->d()->request;
	return Encode(r->timeout());
}

ReturnedValue QQmlXMLHttpRequestCtor::method_set_timeout(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_withCredentials(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
      V4THROW_REFERENCE("Not an XMLHttpRequest object");
  QQmlXMLHttpRequest *r = w->d()->request;
	return Encode(r->withCredentials());
}

ReturnedValue QQmlXMLHttpRequestCtor::method_set_withCredentials(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_responseURL(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
  ...
  QQmlXMLHttpRequest *r = w->d()->request;
#if (QT_VERSION >= QT_VERSION_CHECK(6, 0, 0))
  return Encode(scope.engine->newUrlObject(r->responseUrl()));
#else
	return Encode(scope.engine->newString(r->responseUrl().toString()));
#endif
}

ReturnedValue QQmlXMLHttpRequestCtor::method_get_responseJSON(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
  ...
  if (r->readyState() != QQmlXMLHttpRequest::Loading &&
          r->readyState() != QQmlXMLHttpRequest::Done)
      RETURN_RESULT(scope.engine->newObject());

	r->setResponseType(QLatin1String("json"));
	RETURN_RESULT(r->jsonResponseBody(scope.engine));
}

ReturnedValue QQmlXMLHttpRequestCtor::method_get_responseBuffer(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
  ...
  if (r->readyState() != QQmlXMLHttpRequest::Loading &&
	...
	r->setResponseType(QLatin1String("arraybuffer"));
	RETURN_RESULT(scope.engine->newArrayBuffer(r->rawResponseBody()));
}

ReturnedValue QQmlXMLHttpRequestCtor::method_get_method(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
      V4THROW_REFERENCE("Not an XMLHttpRequest object");
  QQmlXMLHttpRequest *r = w->d()->request;
  return Encode(scope.engine->newString(r->method()));
}

ReturnedValue QQmlXMLHttpRequestCtor::method_set_method(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_url(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
  ...
  QQmlXMLHttpRequest *r = w->d()->request;
#if (QT_VERSION >= QT_VERSION_CHECK(6, 0, 0))
  return Encode(scope.engine->newUrlObject(r->url()));
#else
	return Encode(scope.engine->newString(r->url().toString()));
#endif
}

ReturnedValue QQmlXMLHttpRequestCtor::method_set_url(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_async(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
      V4THROW_REFERENCE("Not an XMLHttpRequest object");
  QQmlXMLHttpRequest *r = w->d()->request;
  return Encode((r->loadType() == QQmlXMLHttpRequest::AsynchronousLoad));
}

ReturnedValue QQmlXMLHttpRequestCtor::method_set_async(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_redirect(const FunctionObject *b, const Value *thisObject, const Value *, int)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
      V4THROW_REFERENCE("Not an XMLHttpRequest object");
  QQmlXMLHttpRequest *r = w->d()->request;
	int redir = r->redirect();
	QString policy;
	switch (redir) {
		case QNetworkRequest::ManualRedirectPolicy:
			policy = QStringLiteral("manual");
			break;
		case QNetworkRequest::NoLessSafeRedirectPolicy:
			policy = QStringLiteral("no-less-safe");
			break;
		case QNetworkRequest::SameOriginRedirectPolicy:
			policy = QStringLiteral("same-origin");
			break;
		case QNetworkRequest::UserVerifiedRedirectPolicy:
			policy = QStringLiteral("error");
			break;
		default:
			policy = QStringLiteral("follow");
			break;
	}
	return Encode(scope.engine->newString(policy));
}

ReturnedValue QQmlXMLHttpRequestCtor::method_set_redirect(const FunctionObject *b, const Value *thisObject, const Value *argv, int argc)
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
  ...
  // Argument 0 - redirect type string
	...
	int redir;
	if (!policy.compare(QLatin1String("manual")))
		redir = QNetworkRequest::ManualRedirectPolicy;
	else if (!policy.compare(QLatin1String("error")))
		redir = QNetworkRequest::UserVerifiedRedirectPolicy;
	else if (!policy.compare(QLatin1String("follow")))
		redir = -1;
	else if (!policy.compare(QLatin1String("no-less-safe")))
		redir = QNetworkRequest::NoLessSafeRedirectPolicy;
...
ReturnedValue QQmlXMLHttpRequestCtor::method_get_headers(const FunctionObject *b, const Value *thisObject, const Value *, int )
{
	Scope scope(b);
  Scoped<QQmlXMLHttpRequestWrapper> w(scope, thisObject->as<QQmlXMLHttpRequestWrapper>());
  if (!w)
  ...
  auto const &headers = r->currentHeaders();
	qsizetype len = headers.length();
	ScopedArrayObject a1(scope, scope.engine->newArrayObject(len));
	for (qsizetype i = 0; i < len; ++i) {
		const auto &hdr = headers.at(i);
		ScopedArrayObject a2(scope, scope.engine->newArrayObject(2));
		a2->arrayPut(0, ScopedString(scope, scope.engine->newString(QString::fromUtf8(hdr.first))));
		a2->arrayPut(1, ScopedString(scope, scope.engine->newString(QString::fromUtf8(hdr.second))));
		a1->arrayPut(i, a2);
	}
	return a1.asReturnedValue();
}


void dse_add_qmlxmlhttprequest(ExecutionEngine *v4)
{
    Scope scope(v4);
    ...
    v4->globalObject->defineReadonlyConfigurableProperty(s, ctor);

//    QQmlXMLHttpRequestData *data = new QQmlXMLHttpRequestData;
//    return data;
}

//void dse_rem_qmlxmlhttprequest(ExecutionEngine * /* engine */, void *d)
//{
