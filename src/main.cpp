...
int main(int argc, char *argv[])
{
	...
	// JSEngine tuning: https://doc.qt.io/qt-6/qtqml-javascript-finetuning.html
	// how often a function needs to be run to be considered for JIT compilation. default: 3
	//qputenv("QV4_JIT_CALL_THRESHOLD", "3");
	// disables the JIT and runs all functions through the interpreter
	//qputenv("QV4_FORCE_INTERPRETER", "1");
	// size of the memory area, in bytes, to be allocated as the JavaScript stack. default: 4MB
	//qputenv("QV4_JS_MAX_STACK_SIZE", "1");
	// the size in bytes of the memory area that will be allocated as the stack for the garbage collector. default: 2MB
	//qputenv("QV4_GC_MAX_STACK_SIZE", "1");
	// enable QJSEngine allocator's aggressive garbage collection (expensive!)
	//qputenv("QV4_MM_AGGRESSIVE_GC", "1");
	// outputs the IR bytecode generated by Qt to the console.
